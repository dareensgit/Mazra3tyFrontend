          ...
          <div className="sign-in4-form1">
            <div className="sign-in4-container2">
              <h2 className="sign-in4-text10 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-in4-text20">Log in</span>
                  </Fragment>
                )}
              </h2>
...
SignIn4.defaultProps = {
  image1Src:
    '/idyllic%20farm%20sunset%20with%20red%20barn%20tractor%20and%20freerange%20chickens%20_%20premium%20ai-generated%20image-1500w.jpg',
