          ...
          <div className="sign-up1-form1">
            <div className="sign-up1-title-root">
              <h2 className="thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up1-text27">
                ...
                <div className="sign-up1-textfield">
                  <div className="sign-up1-container2">
                    ...
                    <div className="sign-up1-hide-password">
                      <svg viewBox="0 0 1024 1024" className="sign-up1-icon1">
            ...
            <div className="sign-up1-container8">
              ...
              >
                {props.content1 ?? (
                  <Fragment>
                    <span className="sign-up1-text28">
                      Sign up now to access exclusive content and special
                      offers.
                    </span>
                  </Fragment>
                )}
            ...
            <button type="submit" className="thq-button-filled sign-up1-button">
              <span className="sign-up1-text25 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up1-text29">Sign Up</span>
                  </Fragment>
                )}
              </span>
            </button>
