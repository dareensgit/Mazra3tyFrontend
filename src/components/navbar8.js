  ...
  return (
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        <img
          src="/mazra%C3%B8%C2%B9ty%20icon-1500h.ico"
          alt="Mazra3ty Logo"
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar8-text23">Farmers</span>
                </Fragment>
              )}
            </a>
            <a href={props.link2Url} className="thq-body-small thq-link">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text17">Customers</span>
                </Fragment>
              )}
            </a>
            <a
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Search Products</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text19">Browse Farmers</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Join Mazra3ty as a farmer to sell your fresh
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text16">
                                  Discover a variety of farm-fresh products and
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text25">
                                  Learn more about our mission and how we
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text20">About Mazra3ty</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page3Description ?? (
                        <Fragment>
                          <span className="navbar8-text25">
                            Learn more about our mission and how we connect
...
Navbar8.defaultProps = {
  ...
  page2ImageAlt: 'Customers Image',
  logoSrc: '/mazra%C3%B8%C2%B9ty%20icon-1500h.ico',
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1701279680282-eddd3e6def8c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzEyNzgzOXw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: undefined,
  link1Url: 'https://www.teleporthq.io',
  link2Url: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1711188054453-77f645f71401?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzEyNzgzOHw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: undefined,
  logoAlt: 'Mazra3ty Logo',
  page4: undefined,
  page1ImageAlt: 'Farmers Image',
  ...
  page3ImageSrc:
    'https://images.unsplash.com/photo-1518719161176-290f990bf5b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMzEyNzgzOXw&ixlib=rb-4.0.3&q=80&w=1080',
