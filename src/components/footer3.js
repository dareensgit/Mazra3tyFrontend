        ...
        <div className="footer3-content">
          ...
          <div className="footer3-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer3-text8">About Us</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer3-text3">Contact Us</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer3-text6">FAQs</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer3-text5">Support</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer3-text2">Blog</span>
                </Fragment>
              )}
            </a>
          </div>
          ...
          <div className="footer3-row">
            <div className="footer3-footer-links">
              ...
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer3-text1">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer3-text7">Cookies Policy</span>
                  </Fragment>
                )}
              </span>
            </div>
