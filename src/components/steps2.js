          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Create an account on Mazra3ty and choose whether you want
                      to sign up as a farmer looking to sell products or as a
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text27">
                      Farmers can list their products for sale, providing
                      details such as price, quantity, and images. Customers can
                      browse through the listings and add products to their
                      cart.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text25">Place an Order</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Customers can review their cart, select the desired
                      products, and proceed to place an order. Farmers will
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Delivery or Pickup</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      Farmers can arrange for delivery or pickup options for the
                      orders received. Customers can track the status of their
                      orders until they receive them.
                    </span>
                  </Fragment>
                )}
              </span>
